...
const talents = [
  ...
  },
  {
    ...
    "company": "Meta",
    "location": "San Francisco, United States",
    "about": "As a Data Scientist at Meta, I focus on leveraging machine learning and AI to drive data-driven decision-making. My expertise lies in predictive modeling, data visualization, and statistical analysis. Passionate about transforming raw data into actionable insights, I enjoy working on complex data challenges that enhance user experience and optimize business strategies.",
    "skills": ["Python", "R", "SQL", "TensorFlow", "PyTorch", "Pandas", "NumPy", "Tableau", "Power BI", "Hadoop", "Spark", "AWS", "BigQuery"],
    "experience": [
      {
        ...
        "startDate": "Jul 2021",
        "endDate": "Present",
        "description": "At Meta, I lead data science projects that improve user engagement and content personalization. I work closely with engineering teams to deploy machine learning models at scale, analyze large datasets, and drive product enhancements using data-driven insights."
      },
      {
        ...
        "startDate": "Sep 2017",
        "endDate": "Jun 2021",
        "description": "Developed machine learning models for recommendation systems, optimized supply chain logistics through predictive analytics, and conducted A/B testing for improving customer experience at Amazon."
      }
    ],
    "certifications": [
      {
        ...
        "issuer": "AWS",
        "issueDate": "Mar 2022",
        "certificateId": "AWSML12345"
      },
      {
        "name": "Google Data Engineer Professional",
        "issuer": "Google",
        "issueDate": "Nov 2021",
        "certificateId": "GCPDE56789"
      }
    ]
  },
  {
    ...
    "company": "IBM",
    "location": "Austin, United States",
    "about": "Experienced DevOps Engineer at IBM specializing in CI/CD pipelines, container orchestration, and cloud automation. Passionate about optimizing development workflows and infrastructure reliability.",
    "skills": ["Docker", "Kubernetes", "Jenkins", "Terraform", "AWS", "GCP", "Ansible", "Linux", "Bash", "Python"],
    "experience": [
      {
        ...
        "startDate": "Jan 2020",
        "endDate": "Present",
        "description": "Managing CI/CD pipelines, automating cloud infrastructure, and improving system reliability through DevOps best practices at IBM."
      },
      {
        ...
        "startDate": "Aug 2017",
        "endDate": "Dec 2019",
        "description": "Worked on cloud infrastructure optimization and automated deployment strategies for enterprise clients at Oracle."
      }
    ],
    "certifications": [
      {
